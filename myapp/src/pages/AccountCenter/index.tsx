import { PlusOutlined, HomeOutlined, ContactsOutlined, ClusterOutlined, LikeOutlined } from '@ant-design/icons';
import { Avatar, Card, Col, Divider, Input, Row, Tag, Statistic } from 'antd';
...
const AccountCenter: React.FC<RouteChildrenProps> = () => {
  ...
  const onSearch = (value: any) =>{
    ...
    ajax("http://localhost:8000/userInfo", params, userInfoCallback)
    ajax("http://localhost:8000/userTags", params, userTagsCallback)
    ajax("http://localhost:8000/loanDefault", params, loanInfoCallback)
    ajax("http://localhost:8000/personal/svm_predict", params, svmRiskInfoCallback)
    ajax("http://localhost:8000/personal/mlp_predict", params, mlpRiskInfoCallback)
    ajax("http://localhost:8000/personal/logistic_predict", params, logisticRiskInfoCallback)
  }
